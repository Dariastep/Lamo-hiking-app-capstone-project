...
export default function NavigationBar() {
  ...
  return (
      ...
      <NavigationSection active={router.pathname === "/"}>
        <NavigationLink href={"/"}>
          ...
          >
            <title>compass</title>
            <path
               fill={router.pathname === "/" ? "white" : "var(--main-text-color)"}
      ...
      <NavigationSection active={router.pathname === "/myRoutes"}>
        <NavigationLink href={"/myRoutes"}>
          ...
          >
            ...
            <path
              fill={router.pathname === "/myRoutes" ? "white" : "var(--main-text-color)"}
            ...
            />
          </svg><LinkName>my routes</LinkName>
        </NavigationLink>
      </NavigationSection>
      <NavigationSection active={router.pathname === "/favorites"}>
        <NavigationLink href={"/favorites"}>
          ...
          >
            <title>heart</title>
            <path
              fill={router.pathname === "/favorites" ? "white" : "var(--main-text-color)"}
              d="M12,21.35L10.55,20.03C5.4,15.36 2,12.27 2,8.5C2,5.41 4.42,3 7.5,3C9.24,3 10.91,3.81 12,5.08C13.09,3.81 14.76,3 16.5,3C19.58,3 22,5.41 22,8.5C22,12.27 18.6,15.36 13.45,20.03L12,21.35Z"
            />
          </svg><LinkName>favorites</LinkName>
        </NavigationLink>
      </NavigationSection>
      <NavigationSection active={router.pathname === "/myProfile"}>
        <NavigationLink href={"/myProfile"}>
          ...
          >
            ...
            <path
      fill={router.pathname === "/myProfile" ? "white" : "var(--main-text-color)"}
    ...
    />
          </svg><LinkName>my profile</LinkName>
        </NavigationLink>
      </NavigationSection>
    </NavigationContainer>
  );
...
color: ${(props) =>
      props.active ? "white" : "var(--main-text-color)"};
font-weight: 400;`;